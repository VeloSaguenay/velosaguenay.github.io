<template>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-md-12">
        <h2>Pour une passion accessible</h2>
        <p>
          ...
          de montagne Le Panoramique à Chicoutimi et le Mont-Bélu Bike-Park de
          La Baie.
        </p>
        <p>
          Émotions fortes, activité modérée ou plein air en famille, le site
          gagne en popularité. Stationnement, piste de type dirt jump, aire
          protégée pour les repas, on travaille fort pour que la communauté
    ...
    <h2 class="partners text-center">Membres du CA</h2>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">
              Président, responsable Mont-Bélu
            </h6>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">
              Vice-président, responsable Mont-Bélu
            </h6>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-2 text-muted">
              Administrateur et responsable du programme de partenariat
            </h6>
          </div>
        </div>
      </div>
    ...
    <div class="row mt-5">
      <div class="col-md-12 text-center">
        <RouterLink to="/involvement" class="btn btn-lg btn-primary mt-3"
